  ...
  return {
    ...
    html: `<div style='background-color: rgba(0,0,0,0.9); color: white; border-radius: 5px; height: 100dvh; padding-top: 20px; padding-left: 10px; padding-right: 10px; display: flex; flex-direction: column; justify-content: space-between;'>
            <div style="padding: 2px 10px 5px 10px;">
              ...
              <p>Welcome <span style=" text-transform: capitalize;">${username}</span>, to My ALX Guardian, come share your journey, share insights, ask questions and also converse with your peers</p>
              <p>Please activate your account with the One Time Password (OTP). OTP expires in ${ttl} hours</p>
              <br/>
              <h2>${otp}</h2>
              <br/>
            </div>
